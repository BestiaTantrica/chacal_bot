        ...
        if is_report_cmd:
            ...
            if state == 'running':
                ...
                try:
                    ...
                    # Caso Clásico: Instance 'Running' pero SSM agent muerto
                    send_telegram("🔌 <b>Arrancando Motores...</b> (Fase de Boot)\nEl servidor está prendiendo. Espere 1 minuto.")
                except Exception as e:
                    error_str = str(e)
