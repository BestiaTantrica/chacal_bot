    ...
    try:
        ...
        if is_report_cmd:
            ...
            if state == 'running':
                ...
                cmd = "cd /home/ec2-user/chacal_bot && git fetch origin && git reset --hard origin/main && python3 scripts/diagnostico_fast.py"
                ...
                try:
                    ...
                    if output_text.strip():
                        ...
                        send_telegram("⏳ <b>Actualizando Sistema...</b> (Reintente en 30s)")
